...
public class Validate {
   public static void main(String[] args) {
      ...
      System.out.println("Please enter state/province:");
      String state = scanner.nextLine();
      System.out.println("Please enter zip/postal code:");
      String zip = scanner.nextLine();
      System.out.println("Please enter phone(please include the area code):");
